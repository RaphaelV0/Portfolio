                ...
                <div className="flex justify-center mb-12">
                    <div className="inline-flex bg-[#0a0a1a] p-1 rounded-full border border-gray-800">
                        ...
                        <button
                            ...
                            className={`px-6 py-2 rounded-full text-sm font-medium transition-all duration-300 ${activeTab === "education"
                        ...
                        <button
                            ...
                            className={`px-6 py-2 rounded-full text-sm font-medium transition-all duration-300 ${activeTab === "work"
                        ...
                        <button
                            ...
                            className={`px-6 py-2 rounded-full text-sm font-medium transition-all duration-300 ${activeTab === "volunteer"
                            ...
                            <div className={`flex ${index % 2 === 0 ? "justify-start md:justify-end" : "justify-start"}`}>
                                <div className={`w-full md:w-5/12 ${index % 2 === 0 ? "ml-8 md:ml-0 md:mr-8 md:text-right" : "ml-8"}`}>
                                    ...
                                    >
                                        ...
                                        {exp.details && (
                                            <button
                                                className={`mt-4 text-sm font-medium ${exp.color === "violet" ? "text-violet-400" :
